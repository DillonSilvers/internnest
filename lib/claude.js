...
async function callClaude({ apiKey, system, user, model = MODELS.free, maxTokens = 750, signal }) {
...
module.exports = { buildMatchPrompt, parseMatchResponse, callClaude, SYSTEM, MODELS, modelFor };
